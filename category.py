...
# ==========title
        lbl_title=Label(self.root,text="Manage Product Cateogory",font=("goudy old style",30),bd=3,relief=RIDGE,bg="#184a45",fg="white").pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        cat_frame.place(x=700,y=90,width=400,height=410)

...
class employeeClass:
    def __init__(self,root):
        ...
        ##===search frame
        SearchFrame=LabelFrame(self.root,text="Search Employee",bd=2,relief=RIDGE,bg="white")
        ...
        txt_search=Entry(SearchFrame,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=200,y=10,height=30,width=310)
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=518,y=9,height=30,width=120)
        ##title
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bd=5,relief=RIDGE,bg="#0f4d7d",fg="white").place(x=50,y=100,width=1000)
        #content
        ##row1
        ...
        txt_empid=Entry(self.root,textvariable=self.var_emp_id,font=("goudy old style",15),bg="lightyellow").place(x=150,y=150,width=200)
        ...
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15),bg="lightyellow").place(x=750,y=150,width=200)
        ##row2
        ...
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=150,y=190,width=200)
        txt_dob=Entry(self.root,textvariable=self.var_dob,font=("goudy old style",15),bg="lightyellow").place(x=500,y=190,width=120)
        txt_doj=Entry(self.root,textvariable=self.var_doj,font=("goudy old style",15),bg="lightyellow").place(x=750,y=190,width=200)
        ##row3
        ...
        txt_email=Entry(self.root,textvariable=self.var_email,font=("goudy old style",15),bg="lightyellow").place(x=150,y=230,width=200)
        txt_pass=Entry(self.root,textvariable=self.var_pass,font=("goudy old style",15),bg="lightyellow").place(x=500,y=230,width=120)
        ...
        cmb_utype.place(x=750,y=230,width=200)
        cmb_utype.current(0)
        ##row4
        ...
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("goudy old style",15),bg="lightyellow").place(x=570,y=270,width=150)
        ##buttons
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=470,y=335,height=28,width=110)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=625,y=335,height=28,width=110)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white",cursor="hand2").place(x=780,y=335,height=28,width=110)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=935,y=335,height=28,width=110)
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get()=="Select":
                messagebox.showerror("Error","Select from the Options",parent=self.root)
